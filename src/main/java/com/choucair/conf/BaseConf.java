...
public class BaseConf {
    ...
    public void setTheStage() {
        ...
        choucairActor = theActorCalled("Miguel");

        choucairActor.can(BrowseTheWeb.with(browser));

        choucairActor.can(CallAnApi
                .at(
        ...
        choucairActor.remember("baseUrl",
                EnvironmentSpecificConfiguration.from(environmentVariables)
